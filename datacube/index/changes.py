...
from datacube.utils import contains, jsonify_document, get_doc_changes
...
def validate_dict_changes(old, new, allowed_changes,
    ...
    :param dict allowed_changes: Dict of offsets that are allowed to change: leaves are functions that validate the value.
