...
.. glossary::
   ...
   Australian Geoscience Data Cube
      An Australian project that developed the python library that became :term:`ODC`.
   ...
   High Performance Computing
      A supercomputer. These days typically a cluster
   ...
   Open Data Cube
      ...
      Software for storing, managing and accessing Earth Observation data, and
      the community formed to further it's development.
   ...
   WMS
   Web Map Service
      A standard for delivery published maps into web browsers and
