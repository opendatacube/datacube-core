...
python ${script_dir}/agdc2gdf.py --storage_type=${storage_type} --satellite=${satellite} --sensor=${sensor} --level=${level} --xmin=${xmin} --xmax=${xmax} --ymin=${ymin} --ymax=${ymax} --tmin=${tmin} --tmax=${tmax} --debug
