...
def test_stats_dates():
    # Winter for 1990
    winter_1990 = list(date_sequence(start=to_datetime('1990-06-01'), end=to_datetime('1990-08'), step_size='3m',
                                     stats_duration='3m'))
    assert winter_1990 == [(parse('1990-06-01'), parse('1990-08-31'))]

    # Every winter from 1990 - 1992
    three_years_of_winter = list(date_sequence(start=to_datetime('1990-06-01'), end=to_datetime('1992-08'),
                                               step_size='1y',
                                               stats_duration='3m'))
    ...
    five_full_years = list(date_sequence(start=to_datetime('1990-01-01'), end=to_datetime('1994'), step_size='1y',
                                         stats_duration='1y'))
    ...
    two_years_of_seasons = list(date_sequence(start=to_datetime('1990-03-01'), end=to_datetime('1992-02'),
                                              step_size='3m',
                                              stats_duration='3m'))
    ...
    monthly = list(date_sequence(start=to_datetime('1990-01-01'), end=to_datetime('1990-06'), step_size='1m',
                                 stats_duration='1m'))
