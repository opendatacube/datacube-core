...
from datacube.storage.cubeaccess.core import Coordinate, Variable
from datacube.storage.cubeaccess.core import StorageUnitVariableProxy, StorageUnitDimensionProxy, StorageUnitStack
from datacube.storage.cubeaccess.storage import FauxStorageUnit
...
def test_geotif_storage_unit():
    from datacube.storage.cubeaccess.storage import GeoTifStorageUnit
...
def test_netcdf_storage_unit():
    from datacube.storage.cubeaccess.storage import NetCDF4StorageUnit
