    ...
    "lineage": {
        ...
        "source_datasets": {
            "ortho": {
                ...
                "product_type": "ortho",
                "id": str(_ortho_uuid),
                "usgs": {"scene_id": "LC81120792014026ASA00"},
                "extent": {
                    "center_dt": datetime.datetime(
                        2014, 1, 26, 2, 5, 23, 126373
                    ).isoformat(),
                    "coord": {
                        "ul": {"lat": -26.37259, "lon": 116.58914},
                        "lr": {"lat": -28.48062, "lon": 118.96145},
                ...
                "format": {"name": "GEOTIFF"},
                "lineage": {
                    "algorithm": {"name": "LPGS", "parameters": {}, "version": "2.4.0"},
                    "machine": {},
                    "source_datasets": {
...
_EXAMPLE_PRODUCT = Product(
    ...
    {"name": "eo", "description": "", "metadata_type": "eo", "metadata": {}},
)
...
DatasetRecord = namedtuple(
    "DatasetRecord",
    ["id", "metadata", "dataset_type_ref", "uris", "added", "added_by", "archived"],
)
...
class MockDb:
    ...
    def insert_dataset(self, metadata_doc, dataset_id, dataset_type_id) -> bool:
        ...
        self.dataset[dataset_id] = DatasetRecord(
            dataset_id, deepcopy(metadata_doc), dataset_type_id, None, None, None, None
        )
        return True
